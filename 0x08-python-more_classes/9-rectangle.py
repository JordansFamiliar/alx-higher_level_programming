...
class Rectangle:
    ...
    Attributes:
        ...
        that counts the number of instances.
    ...
    Methods:
        ...
        __del__: A method that ensures the proper deletion of an
        instance of Rectangle.
        bigger_or_equal: A static method that returns the largest of 2
        rectangles.
        square: A class method that returns a new Rectangle instance
    ...
    def bigger_or_equal(rect_1, rect_2):
        """A staic method that returns the biggest rectangle based
        on area.
        """
